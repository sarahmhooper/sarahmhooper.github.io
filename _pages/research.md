...
**Past work.** During my Ph.D., I focused on a line of work around medical image segmentation. I developed methods to train segmentation networks with limited labeled data [[1](#pub1), [4](#pub4), [10](#pub10)], evaluated networks on clinical tasks [[1](#pub1), [12](#pub12)], and explored how to leverage segmentation to improve other ML pipelines [[3](#pub3), ongoing]. As an undergraduate at Rice University, I worked with a large team investigating automated seizure detection to control deep brain stimulation systems [[11](#pub11), [18](#pub18), [19](#pub19)]. 
